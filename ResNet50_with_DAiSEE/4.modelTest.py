...
try:
    model = load_model(os.path.join(Config.MODEL_DIR, 'emotion_recognition_model.h5'), compile=False)
    ...
    while True:
        ...
        if results.detections:
            for detection in results.detections:
                ...
                # Resize the face to the size required by your model (typically 224x224 for ResNet50)
                ...
                labels = ['Boredom', 'Confusion', 'Engagement', 'Frustration']  # Modify based on your model
